...
class UserManagementScreen extends StatefulWidget {
  static const routeName = '/usermanagement_screen';

  final bool isView;

  UserManagementScreen({@required this.isView});
...
class _UserManagementScreenState extends State<UserManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(
                                      authNotifier.otherUserList[0].imageUrl != null
                                          ? authNotifier
                                              .otherUserList[0].imageUrl
      ...
      Expanded(child: Container(child: CommentWidget(isView: true,)))
                            ],
                          ),
                        ),
                      ],
