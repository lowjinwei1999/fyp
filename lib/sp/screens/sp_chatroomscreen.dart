...
class SpChatRoomScreen extends StatefulWidget {
  static const routeName = '/chatroom-screen';

  final bool isChat;

  SpChatRoomScreen({@required this.isChat});
  @override
  _SpChatRoomScreenState createState() => _SpChatRoomScreenState();
}

class _SpChatRoomScreenState extends State<SpChatRoomScreen> {
  var isInit = true;
  var isLoading;
  ...
  //     // Firestore.instance
  //     //     .collection('users')
  //     //     .document('lxZ0lZM6fSPLTUdWB8cHq2zGNsC3')
  //     //     .updateData({'androidNotificationToken': deviceToken});
  //     print('DevecToken:$deviceToken');
  //   });
  // }
