...
class SpNotificationScreenList extends StatefulWidget {
  @override
  _SpNotificationScreenListState createState() => _SpNotificationScreenListState();
}

class _SpNotificationScreenListState extends State<SpNotificationScreenList> {
  @override
